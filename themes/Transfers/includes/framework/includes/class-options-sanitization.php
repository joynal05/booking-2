...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'transfers' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'transfers' ),
		'repeat-y'  => __( 'Repeat Vertically', 'transfers' ),
		'repeat'    => __( 'Repeat All', 'transfers' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'transfers' ),
		'top center'    => __( 'Top Center', 'transfers' ),
		'top right'     => __( 'Top Right', 'transfers' ),
		'center left'   => __( 'Middle Left', 'transfers' ),
		'center center' => __( 'Middle Center', 'transfers' ),
		'center right'  => __( 'Middle Right', 'transfers' ),
		'bottom left'   => __( 'Bottom Left', 'transfers' ),
		'bottom center' => __( 'Bottom Center', 'transfers' ),
		'bottom right'  => __( 'Bottom Right', 'transfers')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'transfers' ),
		'fixed'  => __( 'Fixed in Place', 'transfers')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'transfers' ),
		'italic'      => __( 'Italic', 'transfers' ),
		'bold'        => __( 'Bold', 'transfers' ),
		'bold italic' => __( 'Bold Italic', 'transfers' )
		);
